  ...
  return (
    <section id="pricing" className="px-4 py-20 scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        <p className="text-[10px] font-mono uppercase tracking-widest text-primary/90 mb-2">Pricing</p>
          ...
          {tiers.map((t) => (
            <div
              ...
              className={`rounded-xl border p-6 flex flex-col ${
                t.highlighted
                  ? "border-primary/50 bg-primary/5 shadow-xl shadow-primary/15 scale-[1.02]"
              ...
              <div className="mt-8">
                {t.sales ? (
                  <a
                    ...
                    className="block w-full text-center rounded-lg border border-primary/40 py-2.5 text-sm font-medium text-primary hover:bg-primary/10"
                  >
                    {t.cta}
                  </a>
                ) : (
