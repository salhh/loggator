  ...
  return (
    <section className="relative px-4 pt-16 pb-20 md:pt-24 md:pb-28 max-w-6xl mx-auto">
      <div className="flex flex-wrap items-center gap-2 mb-6">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-400/30 bg-cyan-400/5 px-3 py-1 text-[11px] font-mono uppercase tracking-wider text-cyan-300/90">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <Link
          href="/login"
          className="inline-flex items-center justify-center rounded-lg bg-cyan-400 text-black px-8 py-3 text-sm font-semibold hover:bg-cyan-300 transition-colors shadow-[0_0_24px_-4px_rgba(34,211,238,0.5)]"
        >
          Sign in
        </Link>
        <a
          href="#features"
          className="inline-flex items-center justify-center rounded-lg border border-cyan-400/40 bg-cyan-400/5 px-8 py-3 text-sm font-medium text-cyan-200 hover:bg-cyan-400/10 transition-colors"
        >
